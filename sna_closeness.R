...
node <- data.frame(id=c(node[1,1],node_id$to_id))
rel_id <- dbGetQuery(connect ,"SELECT * FROM weight WHERE from_id=1")
...
visSave(closeness_pic, file = "E:/GitHub/closeness.html",selfcontained = FALSE, background = "white")