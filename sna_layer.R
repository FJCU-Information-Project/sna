...
layerTable<- data.frame(node_from_id = c(all_from_layer_node $from_id)
                        ,node_from_name = c(all_from_layer_node $name.x)
                        ,node_from_attr_name = c(all_from_layer_node $attr_name.x)
                        ,node_from_eng_name = c(all_from_layer_node $enname.x)
                        ,node_to_id = c(all_layer_node $id)
                        ,node_to_name = c(all_layer_node $name)
                        ,node_to_attr_name = c(all_layer_node $attr_name)
                        ,node_to_eng_name = c(all_layer_node $enname)
