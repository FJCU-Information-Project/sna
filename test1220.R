...
r1<- dbGetQuery(connect ,"select * from `relationship` where `id`<1245")
...
t2<- dbGetQuery(connect ,"select * from `relationship` where `id`<1245")
...
visSave(ccout, file = "E:/GitHub/test.html",selfcontained = FALSE, background = "white")
